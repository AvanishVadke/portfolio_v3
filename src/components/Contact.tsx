  ...
  return (
    <footer id="connect" aria-label="Connect" className="py-12 sm:py-16">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <p className="mt-2 text-neutral-300">Open to jobs, internships, part‑time roles, and collaborations.</p>

        <div className="mt-6 grid gap-3 sm:grid-cols-2">
          <a href="mailto:avanishvadke001@gmail.com" className="inline-flex items-center gap-2 text-white/90 hover:text-[#EA4335] transition-colors" aria-label="Send email">
