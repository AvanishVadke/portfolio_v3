...
import { FaJava, FaAws } from "react-icons/fa6"; // ✅ use FaAws here
...
const techLogos = [
  ...
  { node: <FaJava color="#f89820" />, title: "Java", href: "https://www.java.com" },
  { node: <TbBrandCpp color="#00599c" />, title: "C++", href: "https://isocpp.org" },
  ...
  { node: <FaAws color="#FF9900" />, title: "AWS", href: "https://aws.amazon.com" }, // ✅ updated
...
const MacOSWindow = () => {
  return (
    <div className="relative w-full h-full bg-black/40 backdrop-blur-2xl border border-white/10 shadow-2xl rounded-2xl overflow-hidden group">
      ...
      {/* Content */}
      <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-8 md:p-12 text-center space-y-6 sm:space-y-8">
        {/* Name */}
        <div className="space-y-2 sm:space-y-3">
          <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-white tracking-wide">
            <TextType
              text={["Avanish Vadke"]}
              typingSpeed={75}
              pauseDuration={1500}
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-400 font-light tracking-wider">
        ...
        <div className="mt-8 sm:mt-12 w-full">
          <div className="h-20 sm:h-20 md:h-24 relative overflow-hidden">
            <LogoLoop
              logos={techLogos}
              speed={100}
              direction="left"
