...
function TimelineIndicator({
  ...
  return (
    <div
      ...
      className={cn(
  // Hollow ring like Origin UI: subtle ring by default, white when completed
  "border-white/30 group-data-completed/timeline-item:border-white bg-transparent absolute size-4 rounded-full border-2 group-data-[orientation=horizontal]/timeline:-top-6 group-data-[orientation=horizontal]/timeline:left-0 group-data-[orientation=horizontal]/timeline:-translate-y-1/2 group-data-[orientation=vertical]/timeline:top-0 group-data-[orientation=vertical]/timeline:-left-6 group-data-[orientation=vertical]/timeline:-translate-x-1/2",
        className
      )}
      aria-hidden="true"
      {...props}
...
function TimelineItem({ step, className, ...props }: TimelineItemProps) {
  ...
  return (
    <div
      ...
      className={cn(
  // White connector line for completed segments, like Origin UI
...
function TimelineSeparator({
  ...
  return (
    <div
      ...
      className={cn(
  // Base rail is subtle; completed segments turn white via parent has[] variant
